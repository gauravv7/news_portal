...
<table>
    ...
    <tr>
		...
		<?php 
		//$list=mysql_query("select DISTINCT groupname from customer WHERE groupname !='' order by groupname asc");
    ...
    <tr><div align="center"><b>Assign to Profile</b></div>
        <td style='width:160px;'>
           ...
           <select multiple="multiple" id='lstBox1'>
            ...
            ?>
            <?php
                $list=mysql_query("select DISTINCT group_name from grouptable order by group_name asc");
            while($row_list=mysql_fetch_assoc($list)){
                ?>
