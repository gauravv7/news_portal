...
if($num != '0'){
 ...
 $query="insert into customer(customer_name,login_id,password,date_of_birth,charges,profilename,uid,active_date,status,expiry_date) values('$customer_name','$login_id','$password','$dob1','$charges','$profile_group','$uid','$currentdate','0','$expire_date')";
    ...
    <tr><div align="center"><b>Assign to Profile</b></div>
        <td style='width:160px;'>
           ...
           <select multiple="multiple" id='lstBox1'>
            ...
            ?>
            <?php
                $list=mysql_query("select DISTINCT group_name from grouptable WHERE status='1' order by group_name asc");
