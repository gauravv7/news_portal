...
$query="insert into result (sno,result_text,profile_name,status,assigned_id) values('','$result_text','$profile_group','1','$assigned_id')";
...
$query1="insert into result_assign (sno,result_text,profile_name,assigned_id,status) values('','$result_text','$profile_group1','$assigned_id','1')";
    ...
    <tr><div align="center"><b>Assign to New Profile</b></div>
        <td style='width:160px;'>
           ...
           <select multiple="multiple" id='lstBox1'>
            ...
            ?>
            <?php
                $list=mysql_query("select DISTINCT profilename from customer UNION select DISTINCT group_name from grouptable");
