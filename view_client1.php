...
$query = "select customer_name,profilename,charges,expiry_date,DATEDIFF(expiry_date,'$currentdate'),sno as sno_now,status,login_id,password,uid,date_of_birth,imei,last_seen from customer";
